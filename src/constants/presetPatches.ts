...
export const PRESET_PATCHES: Patch[] = [
  ...
  },
  {
    ...
    params: {
      ...
      hammondPercussionHarmonic: 'third',
      hammondPercussionDecay: 'fast',
      hammondPercussionVolume: 'soft',
      hammondKeyClick: 0.85,
      leslieMix: 0.8,
      leslieSpeed: 'lo',
      leslieRate: 0.9,
      leslieDepth: 0.5,
  ...
  },
  {
    ...
    params: {
      ...
      hammondDb1: 0,
      hammondPercussionEnabled: true,
      hammondPercussionHarmonic: 'second',
      hammondPercussionDecay: 'slow',
      hammondPercussionVolume: 'soft',
      hammondKeyClick: 0.3,
      leslieMix: 0.8,
      leslieSpeed: 'lo',
  ...
  {
    id: "organ-vox-continental",
    name: "Vox Continental 60s British",
    params: {
      ...DEFAULT_PARAMS,
      synthEngine: 'jupiter',
      vco1Waveform: 'pulse',
        ...
        operators: [
          {
            rates: [99, 99, 99, 99],
            levels: [99, 99, 99, 99],
            breakpoint: 0, leftDepth: 0, rightDepth: 0, leftCurve: 0, rightCurve: 0,
            rateScaling: 0, detune: 0, ams: 0, velocitySensitivity: 0, level: 92,
            mode: 0, coarse: 0, fine: 50
          },
          {
            rates: [99, 99, 99, 99],
            levels: [99, 99, 99, 99],
            breakpoint: 0, leftDepth: 0, rightDepth: 0, leftCurve: 0, rightCurve: 0,
            rateScaling: 0, detune: 0, ams: 0, velocitySensitivity: 0, level: 99,
          ...
          },
          {
            ...
            levels: [99, 99, 99, 99],
            breakpoint: 0, leftDepth: 0, rightDepth: 0, leftCurve: 0, rightCurve: 0,
            rateScaling: 0, detune: 0, ams: 0, velocitySensitivity: 0, level: 85,
            mode: 0, coarse: 1, fine: 50
          },
          {
            rates: [99, 99, 99, 99],
            levels: [99, 99, 99, 99],
            breakpoint: 0, leftDepth: 0, rightDepth: 0, leftCurve: 0, rightCurve: 0,
            rateScaling: 0, detune: 0, ams: 0, velocitySensitivity: 0, level: 88,
          ...
          },
          {
            ...
            levels: [99, 99, 99, 99],
            breakpoint: 0, leftDepth: 0, rightDepth: 0, leftCurve: 0, rightCurve: 0,
            rateScaling: 0, detune: 0, ams: 0, velocitySensitivity: 0, level: 75,
          ...
          },
          {
            ...
            levels: [99, 99, 99, 99],
            breakpoint: 0, leftDepth: 0, rightDepth: 0, leftCurve: 0, rightCurve: 0,
            rateScaling: 0, detune: 0, ams: 0, velocitySensitivity: 0, level: 82,
  ...
  {
    id: "strings-fragile-sting",
    name: "Fragile Backing Strings",
    params: {
      ...DEFAULT_PARAMS,
      vco1Waveform: "pulse",
      vco1Range: 8,
